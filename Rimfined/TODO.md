...
- **Description:** Add a gizmo on construction blueprints to set construction priority. Pawns will prioritize higher priority blueprints when choosing what to build next.
